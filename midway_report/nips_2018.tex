...
[6] Pedregosa et al. (2011). Scikit-learn: Machine Learning in Python. In {\it Journal of Machine Learning Research 12} (pp. 2825-2830).

[7] Wang, S., & Manning, C. D. (2012, July). Baselines and bigrams: Simple, good sentiment and topic classification. In {\it Proceedings of the 50th Annual Meeting of the Association for Computational Linguistics: Short Papers-Volume 2 }(pp. 90-94). Association for Computational Linguistics.
